...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecipeAdapterViewHolder> {
    ...
    public class RecipeAdapterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        private TextView mMissingCount;
        ...
        public RecipeAdapterViewHolder(View view) {
            ...
            mUsedCount = (TextView) view.findViewById(R.id.tv_used_ingredients_count);
            mMissingCount = (TextView) view.findViewById(R.id.tv_missed_ingredients_count);
        ...
        public void onClick(View view) {
            ...
            int id = -1;
            try {
                JSONObject recipe = mRecipeResults.getJSONObject(adapterPosition);
                id = recipe.getInt("id");
    ...
    public void onBindViewHolder(RecipeAdapterViewHolder viewHolder, int position) {
        ...
        try {
            ...
            usedCount = recipe.getString("usedIngredientCount");
            missedCount = recipe.getString("missedIngredientCount");
        ...
        viewHolder.mUsedCount.setText(usedCount + " ingredients used");
        viewHolder.mMissingCount.setText(missedCount + " ingredients missing");
    ...
    public int getItemCount() {
        ...
        if (mRecipeResults == null) {
            return 0;
        }
        return mRecipeResults.length();
    }

    public void setData(JSONArray resultsData) {
        this.mRecipeResults = resultsData;
