...
public class FoodDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                /*
                 * FoodEntry did not explicitly declare a column called "_ID". However,
                 * FoodEntry implements the interface, "BaseColumns", which does have a field
                 * named "_ID". We use that here to designate our table's primary key.
                 */
                FoodEntry._ID               + " INTEGER PRIMARY KEY AUTOINCREMENT, " +

                FoodEntry.COLUMN_DATE       + " INTEGER NOT NULL, "                 +

                FoodEntry.COLUMN_NAME + " TEXT NOT NULL, " +

                 "UNIQUE (" + FoodEntry.COLUMN_NAME  + ") ON CONFLICT IGNORE);";
                 ...
                 */
//                " UNIQUE (" + FoodEntry.COLUMN_DATE + ") ON CONFLICT REPLACE);";
