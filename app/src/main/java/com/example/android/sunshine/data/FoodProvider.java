...
public class FoodProvider extends ContentProvider {
     ...
     */
    public static final int CODE_FOOD = 100;
    public static final int CODE_FOOD_WITH_DATE = 101;

    /*
     * The URI Matcher used by this content provider. The leading "s" in this variable name
     * signifies that this UriMatcher is a static member variable of FoodProvider and is a
    ...
    /**
     * Creates the UriMatcher that will match each URI to the CODE_FOOD and
     * CODE_FOOD_WITH_DATE constants defined above.
     * <p>
     ...
     * reason not to.
     *
     * @return A UriMatcher that correctly matches the constants for CODE_FOOD and CODE_FOOD_WITH_DATE
     */
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In Sunshine, we use CODE_FOOD or CODE_FOOD_WITH_DATE.
         */

        /* This URI is content://com.example.android.sunshine/weather/ */
        matcher.addURI(authority, FoodContract.PATH_WEATHER, CODE_FOOD);

        /*
         * This URI would look something like content://com.example.android.sunshine/weather/1472214172
         * The "/#" signifies to the UriMatcher that if PATH_WEATHER is followed by ANY number,
         * that it should return the CODE_FOOD_WITH_DATE code
         */
        matcher.addURI(authority, FoodContract.PATH_WEATHER + "/#", CODE_FOOD_WITH_DATE);
    ...
    public boolean onCreate() {
         ...
         * lengthy operations will cause lag in your app. Since FoodDbHelper's constructor is
            ...
            case CODE_FOOD:
                ...
                try {
                    for (ContentValues value : values) {
                        long weatherDate =
                                value.getAsLong(FoodContract.FoodEntry.COLUMN_DATE);
                        if (!CustomDateUtils.isDateNormalized(weatherDate)) {
...
//                         practice to limit the columns returned in the Cursor with a projection.
                        projection,
//                         * The URI that matches CODE_FOOD_WITH_DATE contains a date at the end
...
//              in our weather table.
     ...
     * override it as FoodProvider extends ContentProvider and getType is an abstract method in
    ...
    /**
     * In Sunshine, we aren't going to do anything with this method. However, we are required to
     * override it as FoodProvider extends ContentProvider and insert is an abstract method in
     * ContentProvider. Rather than the single insert method, we are only going to implement
     * {@link FoodProvider#bulkInsert}.
     *
